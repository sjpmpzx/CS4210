...
# SPECIFICATION: Test the accuracy of a singel layer perceptron and a mlp classifiers and output the best performance for each of them
...
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            #--> add your Python code here
            if a == 0 and accuracy > p_highest_accuracy:
               p_highest_accuracy = accuracy
               print(f"Highest Perceptron accuracy so far: {p_highest_accuracy}, Parameters: learning rate={w}, shuffle={b}")
            elif a != 0 and accuracy > mlp_highest_accuracy:
               mlp_highest_accuracy = accuracy
               print(f"Highest MLP accuracy so far: {mlp_highest_accuracy}, Parameters: learning rate={w}, shuffle={b}")
